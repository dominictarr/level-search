...
var db = sublevel(level('level-search--non-leaf-regex', {encoding: 'json'}))
...
tape('init', function (t) {
  db.batch([
    ...
    {
      key: 'substack',  
      value: {location: {Country: 'usa', City: 'oakland', State: 'california' }},
      type: 'put'
    },
    {
      key: 'hank',  
